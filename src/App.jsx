...
import EmploymentDetails from './pages/hr/EmploymentDetails';
...
import DeductionsCompliance from './pages/hr/DeductionsCompliance';
import PayrollPeriods from './pages/hr/PayrollPeriods';
import SpecialEarnings from './pages/hr/SpecialEarnings';
import EmployeePayrollOverview from './pages/hr/EmployeePayrollOverview';
import AttendanceDTR from './pages/hr/AttendanceDTR';
import AllowancesManagement from './pages/hr/AllowancesManagement';
import GovernmentContributions from './pages/hr/GovernmentContributions';
import PayrollAdjustments from './pages/hr/PayrollAdjustments';
...
import RemittancesAndLoans from './pages/hr/RemittancesAndLoans';
import StatutoryContributionsSetup from './pages/hr/StatutoryContributionsSetup';
import BasicPayAssignment from './pages/hr/BasicPayAssignment';
        ...
        >
          ...
          <Box sx={{ flex: 1, overflowY: 'auto', width: '100%', display: 'flex', flexDirection: 'column' }}>
            <Routes>
              ...
              <Route path="/hr/employees" element={<Navigate to="/hr/employees/list" replace />} />
              <Route path="/hr/employees/list" element={<EmployeeList />} />
              <Route path="/hr/employees/master-file" element={<EmployeeMasterFile />} />
              <Route path="/hr/employees/employment-details" element={<EmploymentDetails />} />
              ...
              <Route path="/hr/payroll/remittances-loans" element={<RemittancesAndLoans />} />
              <Route path="/hr/payroll/statutory-setup" element={<StatutoryContributionsSetup />} />
              <Route path="/hr/payroll/basic-pay-assignment" element={<BasicPayAssignment />} />
              <Route path="/hr/payroll/salary-adjustment" element={<SalaryAdjustment />} />
              <Route path="/hr/payroll/allowances" element={<Allowances />} />
              <Route path="/hr/payroll/salary-history" element={<SalaryHistory />} />
              <Route path="/hr/payroll/adjustments" element={<PayrollAdjustments />} />
              <Route path="/hr/payroll/reports" element={<PayrollReports />} />
              <Route path="/hr/payroll/special-earnings" element={<SpecialEarnings />} />
              <Route path="/hr/payroll/attendance" element={<AttendanceDTR />} />
              <Route path="/hr/payroll/periods" element={<PayrollPeriods />} />
              <Route path="/hr/payroll/allowances-management" element={<AllowancesManagement />} />
              ...
              <Route path="/hr/payroll/deductions" element={<DeductionsCompliance />} />
